;window.CloudflareApps=window.CloudflareApps||{};CloudflareApps.siteId="1a750fa651b2d48c4838d160152a816c";CloudflareApps.installs=CloudflareApps.installs||{};;(function(){'use strict'
...
return false}}());CloudflareApps.installs["CGbPlfFudFdA"]={appId:"nt4L5NPJq1za",scope:{}};;CloudflareApps.installs["CGbPlfFudFdA"].options={"blocks":[]};;CloudflareApps.installs["CGbPlfFudFdA"].URLPatterns=["^courses.edx.org/?.*$","^courses.stage.edx.org/?.*$","^learning.edx.org/?.*$","^learning.stage.edx.org/?.*$","^stage.edx.org/?.*$","^studio.edx.org/?.*$","^studio.stage.edx.org/?.*$","^support-tools.stage.edx.org/?.*$","^www.edx.org/?.*$"];;if(CloudflareApps.matchPage(CloudflareApps.installs['CGbPlfFudFdA'].URLPatterns)){(function(){'use strict'
if(!document.addEventListener)return
var options=CloudflareApps.installs['CGbPlfFudFdA'].options
var elements={}
var prevElements={}
...
window.CloudflareApps.installs['CGbPlfFudFdA'].scope={setOptions:function(nextOptions){options=nextOptions
updateElements()}}}())}